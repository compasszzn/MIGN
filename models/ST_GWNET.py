...
class Model(nn.Module):
    ...
    def __init__(self, feature,tnorm_bool=False, snorm_bool=False, in_dim=1, out_dim=2, channels=1, kernel_size=1, blocks=1, layers=1):
    ...
    def forward(self, history_data: torch.Tensor,a=None,b=None) -> torch.Tensor:
