...
class Weather(object):
    ...
    def __init__(self, raw_data_dir=os.path.join("/home/zinanzheng/project/insitu/data/step2_generate_data", "data"), area="Europe"):
    ...
    def _read_web_data(self):
        if self.area == "Europe":
            A = np.load(os.path.join(self.raw_data_dir, "Europe_sparse_adjacency_matrix.npy"))
            X = np.load(os.path.join(self.raw_data_dir, "Europe_node_values.npy"))
        elif self.area == "America":
            A = np.load(os.path.join(self.raw_data_dir, "America_sparse_adjacency_matrix.npy"))
            X = np.load(os.path.join(self.raw_data_dir, "America_node_values.npy"))
